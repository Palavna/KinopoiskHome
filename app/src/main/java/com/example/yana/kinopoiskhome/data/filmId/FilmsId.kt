package com.example.yana.kinopoiskhome.data.filmId
...
data class FilmsId (
	...
	@SerializedName("ratingAwait") val ratingAwait : String?,
	@SerializedName("ratingAwaitCount") val ratingAwaitCount : Int?,
	@SerializedName("ratingRfCritics") val ratingRfCritics : String?,
